...
## makeCacheMatric function creates a special Matrix object which can cache inverse its inverse
## cacheSolve function computes the inverse of special matrix, if inverse is already calculated it ruturns
## inverse from cache
